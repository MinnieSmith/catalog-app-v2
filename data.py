...
from database_setup import Base, DrugClass, Drug, NewDrugs
...
# New Drugs
# Umeclidinium
drug13 = NewDrugs(name="Umeclidinium", user_id=1, information=" ".join([
...
drug14 = NewDrugs(name="Milnacipran", user_id=1, information=" ".join([
